...
const InstitutionUniversities = () => {
  ...
  const confirmToggle = () => {
    ...
    try {
        db.toggleUniversityLock(user.institutionId, selectedUniv.id, user.role);
        setRefresh(p => p + 1);
        closeModal();
    } catch (e: any) {
        alert(e.message);
                ...
                <div className="p-6">
                    ...
                    <div className="flex items-center justify-end gap-3">
                        ...
                        <button 
                            ...
                            className={`px-5 py-2.5 text-white font-semibold rounded-xl shadow-lg transition-all transform active:scale-95 ${
                                isCurrentlyUnlocked
